# Exercise 1 - Section 4 - Chapter 6
...
### Answers
The test code provided by the course's website already provide us with an additional characteristic, and followed by additional tests:
> C5: collection in consistent state while iterator in use. (boolean partition)
